    ...
    >
      <div className="relative w-full max-w-2xl mx-4 bg-white rounded-2xl shadow-2xl">
        ...
        <div className="px-8 pt-8 pb-4 text-center">
          <h2 className="text-2xl font-bold text-slate-800">{t('documents.loadNew')}</h2>
          <p className="text-slate-500 mt-1">{t('landing.description')}</p>
        </div>
        ...
        <div className="px-8 pb-8">
          <div
            className={`
              ...
              w-full p-12 rounded-xl
              transition-all duration-200 ease-out cursor-pointer
              bg-slate-50 border-2 border-dashed
              ${isDragOver
                ? 'border-primary-500 bg-primary-50 shadow-lg'
                : 'border-slate-300 hover:border-primary-400 hover:bg-white'
              }
            `}
          ...
          >
            ...
            <div className={`
              mb-4 p-3 rounded-xl
              ${isDragOver ? 'bg-primary-100' : 'bg-white border border-slate-200'}
              transition-all duration-200
            `}>
              <svg
                className={`w-10 h-10 transition-all duration-200 ${isDragOver ? 'text-primary-600' : 'text-slate-400'}`}
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth={1.5}
